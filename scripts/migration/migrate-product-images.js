...
// Käivita: SUPABASE_SERVICE_ROLE_KEY=<key> NEXT_PUBLIC_SUPABASE_URL=<url> node scripts/migration/migrate-product-images.js
...
if (!SUPABASE_URL || !SERVICE_ROLE_KEY) {
  ...
  console.error('Usage: SUPABASE_SERVICE_ROLE_KEY=<key> NEXT_PUBLIC_SUPABASE_URL=<url> node scripts/migration/migrate-product-images.js');
  process.exit(1);
}
...
async function main() {
  console.log('=== Piltide migreerimine (Node v18+ native fetch) ===');
