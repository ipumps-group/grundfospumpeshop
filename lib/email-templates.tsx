...
export function buildOrderConfirmationHtml(d: OrderConfirmationData): string {
  ...
  const orderUrl = `https://grundfospump.ee/tellimus/${d.orderRef}${d.customerEmail ? `?email=${encodeURIComponent(d.customerEmail)}` : ''}`
  ...
  const content = `
    ...
    <p style="margin:0;font-size:14px;color:#64748b;">
      Küsimuste korral võtke ühendust: <a href="mailto:info@grundfospump.ee" style="color:${PRIMARY};">info@grundfospump.ee</a>
    </p>`
